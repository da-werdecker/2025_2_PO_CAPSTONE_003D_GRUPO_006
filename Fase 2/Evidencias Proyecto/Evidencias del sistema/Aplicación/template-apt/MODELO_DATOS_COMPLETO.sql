-- =================================================================================
-- MODELO DE DATOS COMPLETO - SISTEMA APT
-- PepsiCo Chile - Gestión de Taller de Vehículos
-- =================================================================================
-- Este archivo contiene todas las tablas necesarias para que el proyecto funcione
-- al 100%. Incluye: tablas, constraints, foreign keys, RLS y datos de semilla.
-- =================================================================================

BEGIN;

-- =================================================================================
-- LIMPIEZA DE OBJETOS EXISTENTES (si es necesario)
-- =================================================================================
DROP TABLE IF EXISTS aprobacion_asignacion_ot CASCADE;
...
-- =================================================================================
-- TABLAS BASE - CATÁLOGOS Y USUARIOS
-- =================================================================================

-- Tabla: cargo
-- Descripción: Puestos de trabajo en la empresa
CREATE TABLE cargo (
...
-- Tabla: usuario
-- Descripción: Cuentas de usuario y autenticación del sistema
...
-- Tabla: tipo_vehiculo
-- Descripción: Clasificación de tipos de vehículos
...
-- Tabla: sucursal
-- Descripción: Sucursales u oficinas de la empresa
...
-- Descripción: Catálogo de modelos de vehículos
...
-- Descripción: Categorías de vehículos (Eléctricos, Diésel, etc.)
...
-- Tabla: modelo_categoria
-- Descripción: Relación entre modelos y categorías (N:N)
...
-- Tabla: vehiculo
-- Descripción: Flota de vehículos de la empresa
...
-- =================================================================================
-- TABLAS DE ÓRDENES DE TRABAJO Y DIAGNÓSTICOS
-- =================================================================================

-- Tabla: tipo_falla
-- Descripción: Catálogo de tipos de fallas
...
-- Tabla: prioridad_ot_catalogo
-- Descripción: Catálogo de prioridades para órdenes de trabajo
...
-- Tabla: estado_ot_catalogo
-- Descripción: Catálogo de estados para órdenes de trabajo
...
-- Tabla: solicitud_diagnostico
-- Descripción: Solicitudes de diagnóstico de vehículos
...
-- Tabla: orden_trabajo
-- Descripción: Órdenes de trabajo para mantenimiento o reparación de vehículos
...
-- Tabla: checklist_diagnostico
-- Descripción: Checklist de diagnóstico para órdenes de trabajo
...
-- Tabla: servicio
-- Descripción: Servicios realizados en órdenes de trabajo
...
-- =================================================================================
-- TABLAS DE REPUESTOS E INVENTARIO
-- =================================================================================

-- Tabla: repuesto
-- Descripción: Inventario de repuestos disponibles
...
-- Tabla: ot_repuesto
-- Descripción: Relación entre órdenes de trabajo y repuestos utilizados (N:N)
...
-- =================================================================================
-- TABLAS DE INCIDENCIAS Y ACCESOS
-- =================================================================================

-- Tabla: incidencia
-- Descripción: Registro de incidencias o problemas relacionados con órdenes de trabajo
...
-- Tabla: acceso
-- Descripción: Control de accesos (ingreso/salida) de vehículos al taller
CREATE TABLE acceso (
...
-- Descripción: Historial de eventos de accesos
...
-- Tabla: llaves
-- Descripción: Control de préstamo y devolución de llaves de vehículos
CREATE TABLE llaves (
...
-- Descripción: Asignación de vehículos a empleados
...
-- Descripción: Historial de acciones de choferes
...
-- Tabla: aprobacion_asignacion_ot
-- Descripción: Aprobaciones de asignación de mecánicos a órdenes de trabajo
...
-- Descripción: Perfiles personalizados de usuario
...
-- Tabla: rol_permiso
-- Descripción: Permisos asignados por rol
...
-- Tabla: config_agenda
-- Descripción: Configuración de la agenda del taller
...
-- Descripción: Auditoría de acciones de usuarios
...
-- =================================================================================
-- POLÍTICAS RLS BÁSICAS (Permisivas para desarrollo)
-- =================================================================================
...
-- Políticas para catálogos de vehículos
...
-- Políticas para vehículos y operaciones
...
-- RESUMEN
-- =================================================================================
-- Total de tablas creadas: 30
-- - Tablas base: 3 (cargo, usuario, empleado)
-- - Tablas de vehículos: 7 (marca, tipo, sucursal, modelo, categoria, modelo_categoria, vehiculo)
-- - Tablas de órdenes: 5 (tipo_falla, prioridad_ot, estado_ot, solicitud_diagnostico, orden_trabajo, checklist)
-- - Tablas de servicios: 2 (servicio, repuesto, ot_repuesto)
-- - Tablas de control: 4 (incidencia, acceso, historial_accesos, llaves)
-- - Tablas adicionales: 9 (asignacion_vehiculo, driver_history, aprobacion_asignacion_ot, perfil_usuario, permiso, rol_permiso, permiso_usuario, config_agenda, notificacion, auditoria_usuario)
-- =================================================================================
